...
/**
 * Created by 1007546 on 25-09-2016.
 */
public class LoadImageFromDBAsyncTask extends AsyncTask<String, Bitmap, Void> {
    private Context context;
    ImageView imageView;

    public LoadImageFromDBAsyncTask(Context context, ImageView imageView) {
